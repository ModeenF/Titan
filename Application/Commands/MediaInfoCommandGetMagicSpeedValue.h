...
#ifndef __MEDIA_INFO_COMMAND_GET_MAGIC_SPEED_VALUE
#define __MEDIA_INFO_COMMAND_GET_MAGIC_SPEED_VALUE
...
class  MediaInfoCommandGetMagicSpeedValue : public EMCommand
{
public:
	
	//Used for command instantiation
	MediaInfoCommandGetMagicSpeedValue();
