...
public:
			...
			bool 			InitializeAudioE(uint64 bufferSize
								= EM_AUDIO_BUFFER_SIZE, int32 numBuffers = 10);
			bool 			InitializeVideoE(uint64 bufferSize,
								int32 numBuffers, media_format* format,
